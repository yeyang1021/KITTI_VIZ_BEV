...
calib = Calibration('/home1/dataset/Kitti/training/calib/%06d.txt'%img_id) ## Path ## need to be changed

path = '/home1/dataset/Kitti/training/velodyne/%06d.bin'%img_id   ## Path ## need to be changed
points = np.fromfile(path, dtype=np.float32).reshape(-1, 4)

df = read_detection('/home1/dataset/Kitti/training/label_2/%06d.txt'%img_id)  ## Path ##  need to be changed
df.head()
